...
from product.api.product_serializers import ProductGetSerializer
from .bulk_upload_serializers import BulkProductUploadSerializer, BulkUploadResponseSerializer
        ...
        try:
            ...
            for row_num, row in enumerate(csv_reader, start=2): 
                try:
                    ...
                    missing_fields = [field for field in required_fields if not row.get(field) or row.get(field).strip() == '']
                    ...
                    created_product = self.service.add(product)
